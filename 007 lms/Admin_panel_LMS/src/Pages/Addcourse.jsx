            ...
            <div className='bg-white w-[100%] mb-[50px] p-4 h-full rounded-[20px]'>
              <form action="" onSubmit={handleAddCourse}>
                ...
                <div className='flex items-center mt-5  mb-8 gap-2'>
                  <input name='status' value={true} type="radio" className='mx-2 w-[20px] h-[20px] text-[20px]' /> Active
                  <input name='status' value={false} type="radio" className='mx-2 w-[20px] h-[20px] text-[20px]' /> Deactive
                </div>
